...
// #define SELECTED_SCUM							6 // PROG
// PORT 37, UART PORT 6 #define SELECTED_SCUM
// 4 // PROG PORT 4, UART PORT LOGIC ANALYZER #define SELECTED_SCUM
// 77 // TEENSY OPTICAL PROG. PORT, NO UART
