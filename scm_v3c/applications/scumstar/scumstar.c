...
// PROG PORT 27, UART PORT// 17 #define SELECTED_SCUM 6 // PROG PORT 37, UART
// PORT 6 #define SELECTED_SCUM 4 // PROG PORT 4, UART PORT LOGIC ANALYZER
// #define SELECTED_SCUM 77 // TEENSY OPTICAL PROG. PORT, NO UART #define
// SELECTED_SCUM 30 #define SELECTED_SCUM 36 #define SELECTED_SCUM 46
    ...
    if (1) {
        ...
        if ((destination_address(
            ...
            if (scumpong_vars.sync_state == DESYNCHED) {
                ...
                // RX_EB_BACKOFF;
                // rftimer_setCompareIn_by_id(app_vars.current_count +
                // time_sync_vars.rx_EB_timer - RX_IF_BACKOFF - RX_EB_BACKOFF,
                // TIMER_CB_RX_EB );

                time_sync_vars.rx_EB_timer = time_sync_vars.rx_EB_timer;
                rftimer_setCompareIn_by_id(app_vars.current_count +
                                               time_sync_vars.rx_EB_timer -
                                               RX_IF_BACKOFF - RX_EB_BACKOFF,
                                           TIMER_CB_RX_EB);
            ...
            if (scumpong_vars.sync_state == DESYNCHED) {
                ...
                if (((app_vars.current_count - app_vars.previous_count) >
                    ...
                    time_sync_vars.rx_EB_timer =
                        ...
                        RX_EB_BACKOFF;  // maintain a "count"
                }
            }
