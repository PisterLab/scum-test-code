...
def test_adc_spot_uart(uart_port="COM16", iterations=1):
	"""
	Inputs:
		uart_port: String. Name of the COM port that the UART 
			is connected to.
...
def test_adc_dnl_uart(vin_min, vin_max, num_bits, 
		uart_port="COM18", 
		psu_name='USB0::0x0957::0x2C07::MY57801384::0::INSTR',
		iterations=1):
	"""
...
def test_adc_inl_straightline_uart(vin_min, vin_max, num_bits, 
		uart_port="COM18", 
		psu_name='USB0::0x0957::0x2C07::MY57801384::0::INSTR',
		iterations=1):
	"""
...
def test_adc_inl_endpoint_uart(vin_min, vin_max, num_bits, 
		uart_port="COM18", 
		psu_name='USB0::0x0957::0x2C07::MY57801384::0::INSTR',
		iterations=1):
	"""
...
if __name__ == "__main__":
	...
	if False:
		...
		test_adc_spot_specs = dict(
			uart_port=scm_port,
			iterations=10)
		adc_out = test_adc_spot_uart(**test_adc_spot_specs)
		print(adc_out)
		adc_out_dict = dict()
	...
	if False:
		...
		test_adc_psu_specs = dict(vin_vec=np.arange(0, 0.9, 0.1e-3),
								...
								psu_name='USB0::0x0957::0x2C07::MY57801384::0::INSTR',
								iterations=100)
		adc_outs = test_adc_psu_uart(**test_adc_psu_specs)
