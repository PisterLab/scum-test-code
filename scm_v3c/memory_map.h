...
#define RFTIMER_REG__COMPARE0          *RFTIMER_REG__COMPARE0_ADDR
#define RFTIMER_REG__COMPARE1          *RFTIMER_REG__COMPARE1_ADDR
#define RFTIMER_REG__COMPARE2          *RFTIMER_REG__COMPARE2_ADDR
#define RFTIMER_REG__COMPARE3          *RFTIMER_REG__COMPARE3_ADDR
#define RFTIMER_REG__COMPARE4          *RFTIMER_REG__COMPARE4_ADDR
#define RFTIMER_REG__COMPARE5          *RFTIMER_REG__COMPARE5_ADDR
#define RFTIMER_REG__COMPARE6          *RFTIMER_REG__COMPARE6_ADDR
#define RFTIMER_REG__COMPARE7          *RFTIMER_REG__COMPARE7_ADDR
#define RFTIMER_REG__COMPARE0_CONTROL  *RFTIMER_REG__COMPARE0_CONTROL_ADDR
#define RFTIMER_REG__COMPARE1_CONTROL  *RFTIMER_REG__COMPARE1_CONTROL_ADDR
#define RFTIMER_REG__COMPARE2_CONTROL  *RFTIMER_REG__COMPARE2_CONTROL_ADDR
#define RFTIMER_REG__COMPARE3_CONTROL  *RFTIMER_REG__COMPARE3_CONTROL_ADDR
#define RFTIMER_REG__COMPARE4_CONTROL  *RFTIMER_REG__COMPARE4_CONTROL_ADDR
#define RFTIMER_REG__COMPARE5_CONTROL  *RFTIMER_REG__COMPARE5_CONTROL_ADDR
#define RFTIMER_REG__COMPARE6_CONTROL  *RFTIMER_REG__COMPARE6_CONTROL_ADDR
#define RFTIMER_REG__COMPARE7_CONTROL  *RFTIMER_REG__COMPARE7_CONTROL_ADDR
